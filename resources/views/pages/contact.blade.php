                ...
                <div class="col-md-12">
                    <div class="aa-contact-area">
                        ...
                        <div class="aa-contact-map">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d9744.321249639874!2d104.92574975889413!3d11.555526852780218!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2skh!4v1629905088171!5m2!1sen!2skh"
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="aa-contact-address-left">
                                        <form action="{{ route('contact.store') }}" class="comments-form contact-form"
                                            method="POST">
                                            {{ csrf_field() }}
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" id="company" name="company" placeholder="Company"
                                                            class="form-control" value="{{ old('company') }}" required>
                                                    </div>
                                                </div>
                                            </div>
