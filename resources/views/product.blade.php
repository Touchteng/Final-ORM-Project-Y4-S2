...
@section('content')
    ...
    <img src="img/product_banner.png" alt="fashion img">
    ...
    <div class="container">
        ...
        <div class="col-lg-3 col-md-3 col-sm-4 col-md-pull-9">
            ...
            <div class="aa-sidebar-widget">
                ...
                <ul>
                    <li>
                    <a href="#" class="aa-cartbox-img"><img alt="img" src="img/product/1.jpg"></a>
                    ...
                    <li>
                    <a href="#" class="aa-cartbox-img"><img alt="img" src="img/product/2.jpg"></a>
                    <div class="aa-cartbox-info">
                        <h4><a href="#">Product Name</a></h4>
                        <p>1 x $250</p>
                    </div>                    
                    ...
                    <li>
                    <a href="#" class="aa-cartbox-img"><img alt="img" src="img/product/3.gif"></a>
                    <div class="aa-cartbox-info">
                        <h4><a href="#">Product Name</a></h4>
                        <p>1 x $250</p>
                    </div>                    
            ...
            <div class="aa-sidebar-widget">
                ...
                <ul>
                    <li>
                    <a href="#" class="aa-cartbox-img"><img alt="img" src="img/product/4.jpeg"></a>
                    <div class="aa-cartbox-info">
                        <h4><a href="#">Product Name</a></h4>
                        <p>1 x $250</p>
                    </div>                    
                    ...
                    <li>
                    <a href="#" class="aa-cartbox-img"><img alt="img" src="img/product/5.jpg"></a>
                    <div class="aa-cartbox-info">
                        <h4><a href="#">Product Name</a></h4>
                        <p>1 x $250</p>
                    </div>                    
                    ...
                    <li>
                    <a href="#" class="aa-cartbox-img"><img alt="img" src="img/product/6.jpg"></a>
                    <div class="aa-cartbox-info">
                        <h4><a href="#">Product Name</a></h4>
                        <p>1 x $250</p>
                    </div>                    
